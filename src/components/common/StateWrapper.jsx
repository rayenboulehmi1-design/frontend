...
import { Loader2, AlertCircle, SearchX, RotateCcw } from "lucide-react";
import { SkeletonCard, SkeletonSection } from "./Skeleton";

/**
 * Universal state wrapper for loading / empty / error / populated states.
 * Ensures no blank cards — every section handles all four states.
 *
 * status: 'loading' | 'success' | 'empty' | 'error' | 'notfound'
 */

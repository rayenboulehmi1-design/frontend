    ...
    <div className="p-5 sm:p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Saved Opportunities</h1>
        </div>
      ...
      {saved.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-12 text-center">
          ...
          <p className="text-slate-400 dark:text-slate-500 mb-4">No saved opportunities yet.</p>
          <Link to={demoLink("/dashboard")} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 transition-colors">
            Browse Intelligence
          </Link>
        </div>
      ) : (

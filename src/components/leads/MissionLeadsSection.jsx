    ...
    <div className="rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-5">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">Leads from Mission Opportunities</h3>
        </div>
        <Link to={demoLink("/leads")} className="inline-flex items-center gap-1 text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700">
          View All <ArrowRight className="w-3 h-3" />
        </Link>
      </div>

      {/* Relationship flow */}
      <div className="flex items-center gap-1 text-xs text-slate-400 dark:text-slate-500 mb-4 flex-wrap">
        <span className="font-medium text-slate-500 dark:text-slate-400">Mission</span>

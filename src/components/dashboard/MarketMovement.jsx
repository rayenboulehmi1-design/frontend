...
function MovementBar({ item, maxCount, color }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-xs text-slate-600 dark:text-slate-400 w-24 truncate shrink-0">{item.name}</span>
      ...
      <span className="text-xs font-semibold text-slate-700 dark:text-slate-300 w-6 text-right shrink-0">{item.count}</span>
    </div>
  );
}
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400">Signal Volume by Country</span>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400">Opportunity Concentration</span>
          </div>
          <div className="space-y-2">

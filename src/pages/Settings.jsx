      ...
      <div className="rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 mb-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-700">Default Category</p>
              <p className="text-xs text-slate-400">Filter dashboard by default</p>
            </div>
            <select
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-slate-700">Min Confidence Threshold</p>
              <p className="text-xs text-slate-400">Hide signals below this score</p>
            </div>
            <select
